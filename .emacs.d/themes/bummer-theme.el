...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(doom-modeline-buffer-modified ((,class (:inherit mode-line :foreground ,warning2 :weight bold))))
   `(doom-modeline-buffer-path ((,class (:inherit mode-line :foreground ,fg3))))
   `(doom-modeline-buffer-major-mode ((,class (:inherit mode-line :foreground ,fg3 :weight bold))))
   `(doom-modeline-buffer-minor-mode ((,class (:inherit mode-line :foreground ,fg4))))
   `(doom-modeline-project-dir ((,class (:inherit mode-line :foreground ,fg3 :weight bold))))
   `(doom-modeline-project-parent-dir ((,class (:inherit mode-line :foreground ,fg4))))
   `(doom-modeline-project-root-dir ((,class (:inherit mode-line :foreground ,fg3))))
   `(doom-modeline-info ((,class (:inherit mode-line :foreground ,type))))
   `(doom-modeline-warning ((,class (:inherit mode-line :foreground ,warning2))))
   `(doom-modeline-urgent ((,class (:inherit mode-line :foreground ,warning))))
   `(doom-modeline-debug ((,class (:inherit mode-line :foreground ,fg4))))
   `(doom-modeline-highlight ((,class (:inherit mode-line :foreground ,keyword))))
   `(doom-modeline-panel ((,class (:inherit mode-line :foreground ,fg1 :background ,bg3))))
   `(doom-modeline-evil-normal-state ((,class (:inherit mode-line :foreground ,type))))
   `(doom-modeline-evil-insert-state ((,class (:inherit mode-line :foreground ,func))))
   `(doom-modeline-evil-visual-state ((,class (:inherit mode-line :foreground ,keyword))))
