...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((t (:foreground ,modelinefg :background ,miscbg :box nil))))
   `(mode-line-active ((t (:foreground ,modelinefg :background ,miscbg :box nil))))
   `(mode-line-inactive ((t (:foreground ,modelinefginactive :background ,bg1 :box nil))))

   `(doom-modeline-bar ((t (:background ,keyword))))
   `(doom-modeline-bar-inactive ((t (:background ,bg1))))

   `(doom-modeline-buffer-file ((,class (:inherit mode-line :foreground ,modelinefg :weight bold))))
   `(doom-modeline-buffer-modified ((,class (:inherit mode-line :foreground ,modelinefg :weight bold))))
   `(doom-modeline-buffer-path ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-buffer-major-mode ((,class (:inherit mode-line :foreground ,modelinefg :weight bold))))
   `(doom-modeline-buffer-minor-mode ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-project-dir ((,class (:inherit mode-line :foreground ,modelinefg :weight bold))))
   `(doom-modeline-project-parent-dir ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-project-root-dir ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-info ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-warning ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-urgent ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-debug ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-highlight ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-panel ((,class (:inherit mode-line :foreground ,modelinefg :background ,bg3))))
   `(doom-modeline-evil-normal-state ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-evil-insert-state ((,class (:inherit mode-line :foreground ,modelinefg))))
   `(doom-modeline-evil-visual-state ((,class (:inherit mode-line :foreground ,modelinefg))))
